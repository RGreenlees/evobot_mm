...
evobot Template - A Bot Template for GoldSrc Games, Built on the Recast and Detour Libraries
===============

## Overview

evobot is a metamod plugin designed to provide AI-controlled players for Half-Life and its mods, either to provide single-player experiences or to fill gaps in a team of humans online.
...
Nav meshes for the bot are generated externally by a specialised tool, and held in the navmeshes folder in the evobot addons directory.
